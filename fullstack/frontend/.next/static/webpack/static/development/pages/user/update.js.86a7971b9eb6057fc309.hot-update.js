...
var imageupload = function imageupload(img) {
  var formData = new FormData();
  formData.append('image', img);
  return fetch('https://api.imgur.com/3/image/', {
    method: "POST",
    headers: {
      'Authorization': "Client-ID ".concat(_config__WEBPACK_IMPORTED_MODULE_0__["API_IMGUR"])
    },
    body: formData
...
//# sourceMappingURL=update.js.86a7971b9eb6057fc309.hot-update.js.map